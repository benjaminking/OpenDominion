...
export class NativeVillageMat extends OwnedUnorderedCardCollection {
  constructor(owner: Player, gameMessageBroadcaster: GameMessageBroadcaster) {
    super(owner, CardLocation.NATIVE_VILLAGE_MAT, gameMessageBroadcaster, PrivacyType.ALL_VISIBLE);
  }
}
